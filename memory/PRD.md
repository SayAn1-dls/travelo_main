...
auth: register/login/me · destinations (region/q filters, 24 total incl. region "India" ×6) · quotes (40)
...
collage/analyze: ≤5 base64 images → {vibe_title, caption, mood, palette[3], hashtags[5], source}
...
/vibe-lab (upload ≤5 → AI vibe → canvas 1080×1920 collage, 3 templates grid/filmstrip/polaroid, download + WhatsApp share via Web Share API / wa.me fallback)
