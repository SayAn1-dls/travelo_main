    ...
    <div className="min-h-screen bg-[#030303] pt-40 pb-20 px-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {trips.map((t) => (
            <div key={t.id} className="silicon-glass group relative">
               ...
               <div className="flex items-center justify-between pt-12 border-t border-white/5">
                  ...
                  <Link to="/dashboard" className="no-underline text-white/40 hover:text-white font-black uppercase text-lg tracking-[0.3em] flex items-center gap-4 italic transition-all">
