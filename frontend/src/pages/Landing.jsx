    ...
    <div className="bg-ink text-white">
      ...
      <section className="relative flex min-h-screen flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-8 pt-32 md:px-8">
          ...
          >
            Est. 2026 — Planet Earth · 12 destinations · 3 tiers · zero excuses
          </motion.p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-8">
        ...
        <div className="space-y-px bg-white/10">
          {[
            { n: '01', icon: Globe2, title: 'Pick a place', desc: 'Twelve hand-picked destinations. Every single one worth crossing the planet for.' },
