...
const HERO = "https://images.pexels.com/photos/27590848/pexels-photo-27590848.jpeg?auto=compress&w=1800";
  ...
  return (
    <div className="bg-[#FDFBF7] min-h-screen">
      <section ref={heroRef} className="relative h-[92vh] min-h-[560px] overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 max-w-7xl mx-auto px-5 sm:px-8 pb-16 sm:pb-24">
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="font-display text-white text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] max-w-3xl">
            Wander far.<br />
            <span className="italic text-[#F9B384]">Split fair.</span>
          </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }} className="flex flex-wrap gap-3 mt-8">
            <Button data-testid="landing-cta-primary" onClick={cta} size="lg" className="rounded-full bg-[#E25822] hover:bg-[#C84B1A] text-white px-8 h-13 text-base">
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
        <p className="uppercase tracking-[0.25em] text-xs font-semibold text-[#E25822] mb-3">Everything in one place</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-12">
          {features.map((f, i) => (
            <motion.div
              ...
              className={`${f.span} bg-white border border-[#EAE3D9] rounded-2xl p-8 hover:shadow-lg hover:-translate-y-1 transition-[box-shadow,transform] duration-300`}
            >
              <f.icon size={36} weight="duotone" className="text-[#E25822]" />
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 pb-20 sm:pb-28">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="uppercase tracking-[0.25em] text-xs font-semibold text-[#E25822] mb-3">Destination hubs</p>
      ...
      <section className="relative bg-[#0B4F6C] text-white overflow-hidden grain">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-20 sm:py-28 grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            <p className="uppercase tracking-[0.25em] text-xs font-semibold text-[#F9B384] mb-3">The group trip, solved</p>
            ...
            <Button data-testid="landing-group-cta" onClick={() => navigate(user ? "/trips" : "/auth")} size="lg" className="rounded-full bg-[#E25822] hover:bg-[#C84B1A] mt-8 px-8">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={r.t} className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-5 flex items-start gap-4">
                <r.icon size={26} weight="duotone" className="text-[#F9B384] mt-0.5" />
                <div>
      ...
      <footer className="max-w-7xl mx-auto px-5 sm:px-8 py-12 flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="flex items-center gap-2">
          <AirplaneTilt size={22} weight="duotone" className="text-[#E25822]" />
