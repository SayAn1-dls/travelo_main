    ...
    <div className="min-h-screen bg-[#030303] flex items-center justify-center p-6 relative overflow-hidden">
       ...
       <div className="w-full max-w-xl relative z-10">
          <div className="text-center mb-16">
             <div className="w-16 h-16 bg-orange-500 rounded-2xl mx-auto flex items-center justify-center mb-12">
                <AirplaneTilt size={36} weight="fill" className="text-white" />
             </div>
             <h1 className="header-massive text-white">COMMAND <br/><span className="text-orange-500 italic">ACCESS.</span></h1>
          </div>
          <div className="silicon-glass border-white/5">
             ...
             <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button type="submit" disabled={loading} className="w-full btn-launch group py-10">
                  {loading ? 'SYNCING...' : <span className="flex items-center gap-4">ENGAGE <ArrowRight size={32} weight="bold" /></span>}
                </button>
             </form>
